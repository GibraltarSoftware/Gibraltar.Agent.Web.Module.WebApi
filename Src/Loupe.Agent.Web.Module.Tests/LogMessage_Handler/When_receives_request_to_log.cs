...
{
    [TestFixture]
    public class When_receives_request_to_log:WebApiTestBase
    {
        ...
        {
            var response= SendRequest("{Session:null, LogMessages:[]}");
        ...
        public void Should_return_status_code_500_if_error_when_trying_to_log_to_loupe()
        {
            ...
            var result = SendRequest("{Session:null, LogMessages:[]}");
